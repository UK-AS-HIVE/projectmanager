...
Tags = new Meteor.Collection('tags', {schema: new SimpleSchema({
	tag:
		{
			type: String,
		}
...
SmallScreenshots = new FS.Collection("smallScreenshots", {stores:[new FS.Store.FileSystem("smallScreenshots")]});